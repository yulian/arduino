...
--------------
### 1장 사물인터넷과 아두이노 알아보기
* 영상01 : 자전거의 속력을 측정해요 -> [바로가기 링크](https://www.youtube.com/watch?v=g6Rz4jPBNFc){:target="_blank"}
* 영상02 : 농작물을 키워요 -> [바로가기 링크](https://www.youtube.com/watch?v=uNkADHZStDE){:target="_blank"}
* 영상03 : 안경으로 데이터를 볼 수 있어요 -> [바로가기 링크](https://www.youtube.com/watch?v=lkl6yVauCKg){:target="_blank"}
* 영상04 : 오또봇을 만들어요 -> [바로가기 링크](https://www.youtube.com/watch?v=VD6sgTo6NOY){:target="_blank"}
* 영상05 : 드론과 RC카를 만들어요 -> [바로가기 링크](https://www.youtube.com/watch?v=1ZrHEypvW-g){:target="_blank"}
